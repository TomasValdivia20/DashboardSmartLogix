...
export default function Envios() {
  ...
  const [formData, setFormData] = useState({ id: '', cliente: '', tipo: 'Envío', estado: 'Completado', fecha: '' });

  useEffect(() => {
    setEnvios([
      { id: '122333', tipo: 'Envío', cliente: 'TOMAS MARTINEZ', fecha: '10 Jun 2026', estado: 'Procesando' },
  ...
  const handleOpenModal = () => {
    setFormData({ id: '', cliente: '', tipo: 'Envío', estado: 'Completado', fecha: '' });
    setIdError(false);
    setIsModalOpen(true);
  };
    ...
    <Layout>
      <div className="container px-6 mx-auto grid">
        <div className="flex justify-between items-center my-6">
          {/* TÍTULO: Gris oscuro en claro para legibilidad, gris claro en oscuro */}
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 p-4">
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg w-96 inline-block border dark:border-gray-700">
            <h3 className="text-xl font-bold mb-4 text-gray-950 dark:text-white border-b dark:border-gray-700 pb-2 uppercase tracking-wide">
              AGREGAR ENVÍO
            </h3>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 p-4">
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-xl w-80 text-center border dark:border-gray-700">
            <p className="text-sm font-medium text-gray-700 dark:text-gray-100 mb-6">
              ¿Desea eliminar este usuario de la lista de envíos?
            </p>
