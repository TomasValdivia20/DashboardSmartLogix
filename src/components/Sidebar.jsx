      ...
      <aside className="z-20 hidden w-64 overflow-y-auto bg-white dark:bg-gray-800 md:block flex-shrink-0">
        <div className="py-4 text-gray-500 dark:text-gray-400">
          ...
          <ul>
            ...
            <li className="relative px-6 py-3">
              <span className={`absolute inset-y-0 left-0 w-1 rounded-tr-lg rounded-br-lg transition-opacity duration-300 ease-in-out ${currentPath === '/pedidos' ? 'opacity-100' : 'opacity-0'}`} style={{ backgroundColor: '#ff7a00' }} aria-hidden="true"></span>
              <Link className={`inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 focus:outline-none ${currentPath === '/pedidos' ? 'text-gray-800 dark:text-gray-100' : ''}`} to="/pedidos">
            ...
            <li className="relative px-6 py-3">
              <span className={`absolute inset-y-0 left-0 w-1 rounded-tr-lg rounded-br-lg transition-opacity duration-300 ease-in-out ${currentPath === '/envios' ? 'opacity-100' : 'opacity-0'}`} style={{ backgroundColor: '#ff7a00' }} aria-hidden="true"></span>
              <Link className={`inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 focus:outline-none ${currentPath === '/envios' ? 'text-gray-800 dark:text-gray-100' : ''}`} to="/envios">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
